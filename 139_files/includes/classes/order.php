...
class order extends base {
  ...
  function query($order_id) {
	...
	//ORDER DELIVERY DATE MOD - Added order_delivery_date to query
    $order_query = "select customers_id, customers_name, customers_company,
                         ...
                         date_purchased, order_delivery_date, orders_status, last_modified, order_total, order_tax, ip_address
                        from " . TABLE_ORDERS . "
	...
	//ORDER DELIVERY DATE MOD - Added order_delivery_date to array
    $this->info = array('currency' => $order->fields['currency'],
                        ...
                        'order_delivery_date' => $order->fields['order_delivery_date'],
...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
    ...
    //intro area
	//ORDER DELIVERY DATE MOD- Added order_delivery_date
