<?php
/**
 * @package extra_definitions/languageDefines for Order Delivery Date
 * @copyright Copyright 2003-2011 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
 * @version $Id: lng_order_delivery_date.php 18697 2011-05-04 14:35:20Z mc12345678 $
 */
 
 /* 
 *
 * Developed for ORDER DELIVERY DATE contribution
 * Zen Cart Version: 1.5.5
 * Modification Date: 2018-08-23
 * Author of this modification: mc12345678
 * Previous author(s) to this modification are: None yet. Newly added in version 2.6.2
