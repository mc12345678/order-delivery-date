...
<?php // BEGIN CEON BACK BUTTON FIX 3.0.0 - 1 of 2
    if (!is_null($ceon_sage_pay_admin_module)) {
      if (class_exists('CeonSagePayAdmin')) {
        CeonSagePayAdmin::handleBackButtonOutput('font-awesome');
      }
    }
    ...
    /*
// END CEON BACK BUTTON FIX 3.0.0 - 1 of 2 ?>
...
<?php // BEGIN CEON BACK BUTTON FIX 1.0.0 - 2 of 3
    */
// END CEON BACK BUTTON FIX 3.0.0 - 2 of 2 ?>
            </div>
          </div>
